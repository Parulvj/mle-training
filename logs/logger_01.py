...
if __name__ == "__main__":
    ...
    logger = configure_logger(log_file=os.path.join(r"C:\Users\vparul\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\vparul\assignment__1_2\mle-training\logs\logging_files","custom_config.log"))
